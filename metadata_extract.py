...
meta = os.path.expanduser(r"~/OGLE-IV/SMC/SMC_IV_metadata.txt")
cleanfile = os.path.expanduser(r"~/OGLE-IV/SMC/cleanfile.csv")

metatype = os.path.expanduser(r"~/OGLE-IV/BLG/BLG_IV_metadata.txt")

typefile = os.path.expanduser(r"~/OGLE-IV/BLG/types.txt")
types = np.loadtxt(typefile, dtype = "str", delimiter = ",", usecols = 1)
mergefile = os.path.expanduser(r"~/OGLE-IV/BLG/bailerjonestypes.csv")
abfile = os.path.expanduser(r"~/OGLE-IV/BLG/RRab_dist.csv")
cfile = os.path.expanduser(r"~/OGLE-IV/BLG/RRc_dist.csv")
dfile = os.path.expanduser(r"~/OGLE-IV/BLG/RRd_dist.csv")
...
def bailerjonestypemerge(bailerjonesdup, types):
    bailerjonesnames = np.loadtxt(bailerjonesdup, dtype="str", skiprows=7, usecols=0)
    numnames = len(bailerjonesnames)
    with open(bailerjonesdup, 'r') as bailerjonesread:
        csv_reader = reader(bailerjonesread)
...
#bailerjonestypemerge(bailerjonesdupfile, types)